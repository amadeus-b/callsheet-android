...
| Document | Contents |
|---|---|
| [Usage](docs/usage.md) | import, daily flow, blocking, callbacks, appointments, agenda |
...
and the app keeps businesses, contacts, calls and appointments in step with that
